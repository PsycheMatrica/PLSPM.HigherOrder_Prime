function [est_W1,est_W2,est_C,est_B,it1,it2,Flag_Converge,Gamma1,Gamma2,Cov_G1,Cov_G2] = ...
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [est_W1,est_C,~,Cov_G1 ,it1,Flag_Converge1,Gamma1,Rho_A] = ALS_BasicPLSPM(z0,W01,B01,modetype1,scheme,correct_type1,ind_sign1,itmax,ceps,N,J,P1);
    [est_W2,est_C2,est_B2,Cov_G2,it2,Flag_Converge2,Gamma2,~] = ALS_BasicPLSPM(Gamma1,W02,B02,modetype2,scheme,correct_type_tp,ind_sign2,itmax,ceps,N,P1,P2);
